...
data:
  ...
  MYSQL_HOST: cm0tYnAxNXQzejNrdDUxNzRuNDdzby5teXNxbC5yZHMuYWxpeXVuY3MuY29t
  MYSQL_PORT: MzMwNg==
  MYSQL_USER: aGVybWVzX3RyYWRl
  MYSQL_PASSWORD: MXR1d2VONjY4OA==
  MYSQL_DATABASE: aGVybWVz
EOF
